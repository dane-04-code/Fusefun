...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Built-in mechanisms to prevent rug pulls and ensure fair distribution."
    },
    {
      icon: Crown,
      title: "King of Hill",
      description: "Compete for the top spot and earn exclusive rewards."
    },
    {
      icon: Users,
        ...
        <div className="container mx-auto px-4 py-20 relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-blue-400 text-sm font-medium">The Fairest Launchpad on Solana</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent">
              Launch Your
              <br />
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Create, launch, and grow your Solana token with built-in anti-rug protection,
              fair distribution, and community-driven features.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Link href="/create">
                <Button size="lg" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-6 text-lg font-semibold rounded-xl shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105">
                  <Rocket className="w-5 h-5 mr-2" />
                  Launch Token
                </Button>
              </Link>
              <Button variant="outline" size="lg" className="border-gray-700 text-gray-300 hover:bg-gray-800 px-8 py-6 text-lg rounded-xl">
      ...
      <section className="py-20 bg-gray-900/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Why Choose FUSE.FUN?</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Built for the future of decentralized finance with cutting-edge features
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-4xl font-bold mb-2">🔥 Trending Tokens</h2>
              <p className="text-gray-400">Discover the hottest tokens on our platform</p>
            </div>
            <div className="flex gap-2">
              <Button variant="outline" className="border-gray-700">New</Button>
              <Button className="bg-blue-600 hover:bg-blue-700">Trending</Button>
              <Button variant="outline" className="border-gray-700">Graduating</Button>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600/10 via-purple-600/10 to-pink-600/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of creators who have successfully launched their tokens on FUSE.FUN
          </p>
          <Link href="/create">
            <Button size="lg" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-12 py-6 text-xl font-semibold rounded-xl shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105">
  ...
  // Dummy Data
  const tokens = [
    { name: "Winnie The Poo", ticker: "POO", creator: "8xH3...abc", marketCap: "$42.0k", progress: 85, isKing: true },
    { name: "Pepe Le Poo", ticker: "PEPE", creator: "4kR9...def", marketCap: "$12.5k", progress: 45 },
    { name: "Doge Coin", ticker: "DOGE", creator: "7mN2...ghi", marketCap: "$8.2k", progress: 20 },
    { name: "Bonk Bonk", ticker: "BONK", creator: "2jL5...jkl", marketCap: "$1.1k", progress: 5 },
    { name: "Wif Hat", ticker: "WIF", creator: "9vB4...mno", marketCap: "$150.0k", progress: 92 },
    { name: "Silly Cat", ticker: "SILLY", creator: "3tQ8...pqr", marketCap: "$3.4k", progress: 12 },
    { name: "Pop Cat", ticker: "POP", creator: "6yU1...stu", marketCap: "$9.8k", progress: 33 },
    { name: "Mog Coin", ticker: "MOG", creator: "1wE7...vwx", marketCap: "$69.0k", progress: 78 },
  ];
