    ...
    return (
        <section className="mb-12 relative overflow-hidden">
            ...
            <div className="text-center mb-10 relative z-10">
                ...
                <h1 className="mb-6 max-w-4xl mx-auto leading-relaxed">
                    <span className="block text-3xl md:text-4xl lg:text-5xl mb-3 text-white/80">The</span>
                    <span
                        className="techy-pulse-title text-4xl md:text-5xl lg:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-primary via-blue-400 to-cyan-400"
                        data-text="Fairest Launchpad"
                    >
                        Fairest Launchpad
                    </span>
                    <span className="block text-3xl md:text-4xl lg:text-5xl mt-3 text-white/80">on Solana</span>
                </h1>
